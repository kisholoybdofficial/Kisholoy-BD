  ...
  return (
    <div className="relative" ref={ref}>
      ...
      {open && (
        <div
          role="menu"
          className="absolute right-0 top-full mt-2 w-48 bg-white dark:bg-slate-900 rounded-2xl border border-stone-200 dark:border-slate-700 shadow-2xl p-1.5 z-50 animate-in fade-in zoom-in-95 duration-150"
        >
          {OPTIONS.map((opt) => {
            const Icon = opt.icon;
            ...
            return (
              <button
                ...
                className={`flex w-full min-h-[44px] items-center gap-2.5 px-3.5 py-2.5 rounded-xl text-xs font-bold transition-colors ${
                  isActive
